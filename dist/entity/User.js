...
var User = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("increment"), _dec3 = (0, _typeorm.Column)("varchar", {
  length: 100
}), _dec4 = (0, _typeorm.Column)("varchar", {
  length: 100
}), _dec5 = (0, _typeorm.CreateDateColumn)("time"), _dec6 = (0, _typeorm.UpdateDateColumn)("time"), _dec7 = (0, _typeorm.OneToMany)(function (type) {
  return _Post.Post;
}, function (post) {
  return post.author;
